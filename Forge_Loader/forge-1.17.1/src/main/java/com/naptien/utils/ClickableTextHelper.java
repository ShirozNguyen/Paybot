...
public class ClickableTextHelper {
     ...
     * được viết ở module MC 1.17.1 — chỉ tồn tại ở module MC ≥1.21.5 với cú pháp record mới
     * ClickEvent.OpenUrl/HoverEvent.ShowText). MC 1.17.1 dùng cú pháp class thường, giống
