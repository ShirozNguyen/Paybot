...
/**
 * ColorGradientUtil — Class chuyên biệt xử lý tô màu Hex, Gradient và mã màu Chat legacy (§/&).
 * Hỗ trợ đồng bộ trên module Common (Fabric / Forge / Architectury / Bukkit).
...
public final class ColorGradientUtil {
    ...
    /**
     * Parse tô màu cho 1 chuỗi text (Hỗ trợ Gradient, Hex &#RRGGBB, <#RRGGBB> và màu &a-f).
     */
    ...
    /**
     * Chuyển RRGGBB thành §x§R§R§G§G§B§B (mã màu Hex chuẩn).
     */
