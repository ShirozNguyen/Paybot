...
/**
 * ForgeVersionAdapter1_18 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_18_x (Forge).
...
public class ForgeVersionAdapter1_18 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Forge-Adapter-1_18_x");
