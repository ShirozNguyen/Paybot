...
/**
 * ForgeVersionAdapter1_16 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_16_x (Forge).
...
public class ForgeVersionAdapter1_16 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Forge-Adapter-1_16_x");
