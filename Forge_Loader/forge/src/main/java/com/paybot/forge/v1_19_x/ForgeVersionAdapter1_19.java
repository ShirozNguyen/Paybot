...
/**
 * ForgeVersionAdapter1_19 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_19_x (Forge).
...
public class ForgeVersionAdapter1_19 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Forge-Adapter-1_19_x");
