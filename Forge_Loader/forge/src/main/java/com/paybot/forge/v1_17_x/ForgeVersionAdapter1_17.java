...
/**
 * ForgeVersionAdapter1_17 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_17_x (Forge).
...
public class ForgeVersionAdapter1_17 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Forge-Adapter-1_17_x");
