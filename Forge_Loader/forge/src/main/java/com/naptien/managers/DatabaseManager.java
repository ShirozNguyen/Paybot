...
public class DatabaseManager {
    ...
    // v5.5.5 Part 58 [FIX — module này (fabric/, forge/ không đánh version) trước đây CHƯA
    // từng nhận fix Part 52/53 lẫn Part 58 dù các module version-cụ-thể khác đã có — đồng bộ
    // đầy đủ 3 lớp fix trong 1 lượt: log timeout rõ ràng (Part 53), fail-closed hasBankOrder
    // (Part 53), và circuit breaker chống bão timeout (Part 58). Xem giải thích đầy đủ ở bản
    // plugin/DatabaseManager.java.
    ...
    private synchronized boolean tryConnectMySQL() {
        // Circuit breaker (Part 58): xem giải thích đầy đủ ở bản plugin/DatabaseManager.java.
        ...
        try {
            ...
            future.cancel(true);
            // v5.5.5 Part 53 [BUG lặp lại y hệt plugin/ — xem LOG.md Part 52 mục 52.3]: TRƯỚC ĐÂY
            // return false hoàn toàn im lặng — log rõ timeout thay vì nuốt im lặng.
