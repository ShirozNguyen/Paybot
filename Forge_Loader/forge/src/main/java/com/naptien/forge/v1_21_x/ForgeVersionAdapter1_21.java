package com.naptien.forge.v1_21_x;
...
public class ForgeVersionAdapter1_21 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Forge-Adapter1_21_x");
    ...
    private synchronized void ensureInitialized() {
        ...
        try {
            ...
            if (holderClass != null) {
                for (Field f : holderClass.getFields()) {
                    ...
                    if (fName.equalsIgnoreCase("CUSTOM_NAME")) customNameComponentType = f.get(null);
                    else if (fName.equalsIgnoreCase("LORE")) loreComponentType = f.get(null);
                    else if (fName.equalsIgnoreCase("CUSTOM_DATA")) customDataComponentType = f.get(null);
                }
            }
        ...
        } catch (Throwable t) { LOGGER.error("[Forge1_21_x] Init error: {}", t.getMessage()); }
    }
    ...
    public void setItemNameAndLore(ItemStack stack, String name, List<String> lore) {
        ...
        if (lore != null && !lore.isEmpty() && loreComponentType != null && itemLoreClass != null && setComponentMethod != null) {
            ...
            } catch (Throwable t) { LOGGER.warn("[Forge1_21_x] set lore failed: {}", t.getMessage()); }
        }
    }
