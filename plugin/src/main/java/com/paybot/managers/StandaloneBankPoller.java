 ...
 * Thay vào đó, PayBotPlugin (thông qua SePayApiClient) tự động poll trực tiếp
...
public class StandaloneBankPoller {
    ...
    public StandaloneBankPoller(PayBotPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void registerOrder(String invoiceId, int amount, String playerName) {
        ...
        // nhờ SePayApiClient poll định kỳ trong PayBotPlugin.
    }

    public void pollPendingOrders() {
        // v5.1.0: Đã chuyển sang tự poll trực tiếp SePay API trong PayBotPlugin 
