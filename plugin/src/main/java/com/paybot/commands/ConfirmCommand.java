...
public class ConfirmCommand implements CommandExecutor {
    ...
    public ConfirmCommand(PayBotPlugin plugin) { this.plugin = plugin; }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        sender.sendMessage(PayBotPlugin.f("§e[PayBot] §fĐang ngắt kết nối..."));
        ...
        SchedulerUtils.runAsync(plugin, () -> {
            ...
            Runnable syncBack = () -> {
                if (ok) {
                    ...
                    plugin.saveConfig();
                    sender.sendMessage(PayBotPlugin.f("§a[PayBot] §fĐã ngắt kết nối thành công!"));
                    sender.sendMessage("§7Toàn bộ cấu hình hệ thống auto đã được xoá.");
                } else {
                    sender.sendMessage(PayBotPlugin.f("§c[PayBot] §fThất bại, thử lại sau."));
                }
            };
