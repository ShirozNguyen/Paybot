...
public class PayBotSetupCommand implements CommandExecutor {
    ...
    public PayBotSetupCommand(PayBotPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        sender.sendMessage(PayBotPlugin.f("§8§m────────────────────────────────────"));
        sender.sendMessage(PayBotPlugin.f("§6§l  PayBot §r§7— Setup Status §7(v" + plugin.getDescription().getVersion() + ")"));
        sender.sendMessage(PayBotPlugin.f("§8§m────────────────────────────────────"));
