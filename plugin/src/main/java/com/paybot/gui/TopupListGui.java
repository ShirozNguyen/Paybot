...
public final class TopupListGui {
    ...
    public static void open(Player player, PayBotPlugin plugin, int page) {
     ...
     */
    public static void open(Player player, PayBotPlugin plugin, int page, String filter) {
    ...
    private static List<OrderEntry> collectOrders(PayBotPlugin plugin, String filter) {
    ...
    public static OrderEntry getOrderBySlot(int slot, PayBotPlugin plugin, int page, String filter) {
