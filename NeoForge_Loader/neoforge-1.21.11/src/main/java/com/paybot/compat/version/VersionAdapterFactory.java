...
import com.paybot.forge.v_modern.NeoForgeVersionAdapterModern;
...
public class VersionAdapterFactory {
    ...
    public static synchronized VersionAdapter getAdapter() {
        ...
        LOGGER.info("[PayBot] Loaded Native Adapter: NeoForgeVersionAdapterModern for neoforge-1.21.11");
