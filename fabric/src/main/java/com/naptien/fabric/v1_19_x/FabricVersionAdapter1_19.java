...
/**
 * FabricVersionAdapter1_19 — Native Adapter cho nhánh Minecraft 1.19.x (1.19.0 -> 1.19.4).
 */
public class FabricVersionAdapter1_19 implements VersionAdapter {
    ...
    public MapItemSavedData getMapSavedData(ItemStack mapItem, ServerLevel world) {
        ...
        } catch (Throwable t) { LOGGER.error("[Fabric1_19_x] getMapSavedData error: {}", t.getMessage()); }
        return null;
    }
