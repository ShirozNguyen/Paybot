...
/**
 * FabricVersionAdapter1_20 — Native Adapter cho nhánh Minecraft 1.20.x (1.20.0 -> 1.20.4 Legacy NBT).
 */
public class FabricVersionAdapter1_20 implements VersionAdapter {
    ...
    public MapItemSavedData getMapSavedData(ItemStack mapItem, ServerLevel world) {
        ...
        } catch (Throwable t) { LOGGER.error("[Fabric1_20_x] getMapSavedData error: {}", t.getMessage()); }
        return null;
    }
