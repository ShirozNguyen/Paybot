...
/**
 * FabricVersionAdapter1_18 — Native Adapter cho nhánh Minecraft 1.18.x (1.18.0 -> 1.18.2).
 */
public class FabricVersionAdapter1_18 implements VersionAdapter {
    ...
    public MapItemSavedData getMapSavedData(ItemStack mapItem, ServerLevel world) {
        ...
        } catch (Throwable t) { LOGGER.error("[Fabric1_18_x] getMapSavedData error: {}", t.getMessage()); }
        return null;
    }
