...
import com.naptien.fabric.v_modern.FabricVersionAdapterModern;
...
public class VersionAdapterFactory {
    ...
    public static synchronized VersionAdapter getAdapter() {
        ...
        cachedAdapter = new FabricVersionAdapterModern();
        LOGGER.info("[PayBot] Loaded Native Adapter: FabricVersionAdapterModern for fabric-1.21.11");
