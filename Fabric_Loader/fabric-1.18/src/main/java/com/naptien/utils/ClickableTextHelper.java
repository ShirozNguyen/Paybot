...
public class ClickableTextHelper {
     ...
     * được viết ở module MC 1.18 — chỉ tồn tại ở module MC ≥1.21.5 với cú pháp record mới
     * ClickEvent.OpenUrl/HoverEvent.ShowText). MC 1.18 dùng cú pháp class thường, giống
