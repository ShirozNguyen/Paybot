// v5.5.5 Part 80: Fix all remaining sendMessage calls in CommandRegistry for fabric-1.18
// v5.5.5 Part 79: Fix p.sendMessage signature for fabric-1.18
...
import com.paybot.gui.*;
import com.paybot.managers.*;
import com.paybot.managers.BanManager;
    ...
    private static void registerCardSetup(CommandDispatcher<CommandSourceStack> d) {
        d.register(Commands.literal("cardsetup")
            ...
            .executes(ctx -> {
                ...
                String sites = String.join(", ", com.paybot.managers.StandaloneCardProcessor.getSupportedSites().keySet());
            ...
            .then(Commands.argument("site", StringArgumentType.word())
                ...
                .suggests((ctx, builder) -> {
                    for (String s : com.paybot.managers.StandaloneCardProcessor.getSupportedSites().keySet()) {
                ...
                .executes(ctx -> {
                    ...
                    if (!com.paybot.managers.StandaloneCardProcessor.getSupportedSites().containsKey(site)) {
