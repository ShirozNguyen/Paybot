...
/**
 * FabricVersionAdapter1_15 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_15_x (Fabric).
...
public class FabricVersionAdapter1_15 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Fabric-Adapter-1_15_x");
