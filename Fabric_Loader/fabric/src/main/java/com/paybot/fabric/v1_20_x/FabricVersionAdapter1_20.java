...
/**
 * FabricVersionAdapter1_20 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_20_x (Fabric).
...
public class FabricVersionAdapter1_20 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Fabric-Adapter-1_20_x");
