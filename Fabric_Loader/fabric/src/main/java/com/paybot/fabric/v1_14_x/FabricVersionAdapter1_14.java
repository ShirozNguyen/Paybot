...
/**
 * FabricVersionAdapter1_14 — Native Adapter cho nhánh Minecraft 1.14.x (1.14.0 -> 1.14.4).
 */
public class FabricVersionAdapter1_14 implements VersionAdapter {
    ...
    public MapItemSavedData getMapSavedData(ItemStack mapItem, ServerLevel world) {
        ...
        } catch (Throwable t) { LOGGER.error("[Fabric1_14_x] getMapSavedData error: {}", t.getMessage()); }
        return null;
    }
