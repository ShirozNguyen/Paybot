package com.paybot.fabric.v1_14_x;
...
/**
 * FabricVersionAdapter1_14 — v5.5.10 Part 126
 * Adapter NBT chuẩn hóa cho nhánh Minecraft 1_14_x (Fabric).
...
public class FabricVersionAdapter1_14 implements VersionAdapter {
    private static final Logger LOGGER = LoggerFactory.getLogger("PayBot-Fabric-Adapter-1_14_x");
