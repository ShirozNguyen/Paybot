...
public class ClickableTextHelper {
     ...
     *
     * v5.5.5 Part 69: bổ sung method còn thiếu (đã bị gọi ở PayBotMod.java nhưng chưa từng
     * được viết ở module MC 1.18.1 — chỉ tồn tại ở module MC ≥1.21.5 với cú pháp record mới
     * ClickEvent.OpenUrl/HoverEvent.ShowText). MC 1.18.1 dùng cú pháp class thường, giống
