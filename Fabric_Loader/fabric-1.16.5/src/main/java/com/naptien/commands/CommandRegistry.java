// v5.5.5 Part 77: Fix (src.getEntity() instanceof ServerPlayer) and p.sendMessage in fabric-1.16.5
// v5.5.5 Part 74: Fix (src.getEntity() instanceof ServerPlayer) and getEntity() for fabric-1.16.5
