// v5.5.5 Part 78: Inferred lambda and robust reflection text extractor for ALLOW_CHAT_MESSAGE in fabric-1.19.2
// v5.5.5 Part 77: Fix Fabric 1.19.2 ALLOW_CHAT_MESSAGE FilteredText API
...
public class PayBotMod implements ModInitializer {
    ...
    public static void init() {
        try {
            com.paybot.compat.LibraryDownloader.checkAndDownloadLibraries(FabricLoader.getInstance().getConfigDir().toFile());
